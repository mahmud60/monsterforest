...
#define LIBRARY_PATH "/usr/local/lib/ImageMagick-6.9.10/"

/* Subdirectory of lib where ImageMagick architecture dependent files are
   installed. */
#define LIBRARY_RELATIVE_PATH "ImageMagick-6.9.10"
...
#define PACKAGE_BUGREPORT "https://github.com/ImageMagick/ImageMagick6/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ImageMagick"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ImageMagick 6.9.10-14"
...
#define PACKAGE_VERSION "6.9.10-14"
