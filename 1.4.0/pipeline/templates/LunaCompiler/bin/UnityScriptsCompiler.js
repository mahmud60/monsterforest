...
Bridge.assembly("UnityScriptsCompiler", function ($asm, globals) {
            ...
            Update: function () {
                ...
                if (this.enemyCount <= this.enemyCountMax) {
                    ...
                    if (this.spawnTime >= this.spawnTimeMax) {
                        ...
                        var botIns = UnityEngine.Object.Instantiate$3(UnityEngine.GameObject, this.enemy[UnityEngine.Random.Range(0, this.enemy.length)], this.enemySpawnPoint[UnityEngine.Random.Range(0, this.enemySpawnPoint.length)].position.$clone(), pc.Quat.IDENTITY.clone(), this.transform);
                        this.spawnTime = 0;
                    }
                }
        ...
        methods: {
            ...
            OnTriggerEnter: function (other) {
                ...
                if (other.gameObject.CompareTag("treeWood") && !this.dead) {
                    DG.Tweening.ShortcutExtensions.DOLookAt(this.transform, other.gameObject.transform.position.$clone(), 0.2);
                ...
                var $enumerator = new Bridge.GeneratorEnumerator(Bridge.fn.bind(this, function () {
                    try {
                        for (;;) {
                            switch ($step) {
                                case 0: {
                                    $enumerator.current = new UnityEngine.WaitForSeconds(1.65);
                                        $step = 1;
                                        return true;
                                }
                                case 1: {
        ...
        methods: {
            ...
            GotToWorld: function () {
                if ((UnityEngine.PlayerPrefs.HasKey("worldKey") ? UnityEngine.PlayerPrefs.GetInt("worldKey") : 0) !== this.worldId) {
                    ...
                    console.log("currentLevel =" + UnityEngine.PlayerPrefs.GetInt("gamelevelKey"));
                }

                //Destroy(sharkWorldPanel.gameObject);
                console.log("goto world number ........" + this.worldId);
    ...
    /*BotSpawner start.*/
    $m("BotSpawner", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[1].Void},{"a":2,"n":"SpawnTimerController","t":8,"sn":"SpawnTimerController","rt":$n[1].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[1].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[1].Void},{"a":2,"n":"clonerMat","t":4,"rt":$n[0].Material,"sn":"clonerMat"},{"a":2,"n":"enemy","t":4,"rt":System.Array.type(UnityEngine.GameObject),"sn":"enemy"},{"a":2,"n":"enemyCount","t":4,"rt":$n[1].Int32,"sn":"enemyCount","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"enemyCountMax","t":4,"rt":$n[1].Int32,"sn":"enemyCountMax","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"enemySpawnPoint","t":4,"rt":System.Array.type(UnityEngine.Transform),"sn":"enemySpawnPoint"},{"a":2,"n":"enemy_cloner","t":4,"rt":$n[0].GameObject,"sn":"enemy_cloner"},{"a":2,"n":"instance","is":true,"t":4,"rt":BotSpawner,"sn":"instance"},{"a":2,"n":"spawnTime","t":4,"rt":$n[1].Single,"sn":"spawnTime","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"spawnTimeMax","t":4,"rt":$n[1].Single,"sn":"spawnTimeMax","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*BotSpawner end.*/
